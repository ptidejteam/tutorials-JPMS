...
- [5-mini-Ptidej-No-JPMS](https://github.com/ptidejteam/tutorials-JPMS/tree/5-mini-Ptidej-No-JPMS), which contains a subset of the Ptidej project. Dependencies are managed using Maven, but there are no modules. Starting point of the second hackathon: the goal is to convert each project into a module.
