...
final class MipsInstruction implements BaseInstruction {
   ...
   public Minstr parseInstr(byte[] var1) {
      ...
      case 18:
         ...
         case 7:
         default:
            throw "Incorrect LDC bytecode".new AssertionException();
         case 8:
            var6 = "a";
         }
      ...
      case 20:
         ...
         case 6:
            ...
            break;
         default:
            throw "Incorrect LDC2_W bytecode".new AssertionException();
         }
   ...
   int getOperand(byte[] var1, int var2, char var3) {
      ...
      case 'v':
         ...
         break;
      default:
         throw "Unknown Operand type..".new AssertionException();
      }
   ...
   public byte[] getCode(int[] var1, int var2) {
      throw "Can't get bytecodes from sparcInstr yet...".new AssertionException();
   }
}
