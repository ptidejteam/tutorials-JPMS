...
public class InstrUtils {
   ...
   private static int vStackEffect(ConstantPool var0, byte[] var1, int var2) {
      ...
      case 197:
         ...
         return -(var3 - 1);
      default:
         throw "Unknown Special Stack Effect".new AssertionException();
      }
   }
      ...
      while(true) {
         ...
         while(!var14 && !var9[var13]) {
            ...
            case 1:
               ...
               if (var17 == null) {
                  throw "Stack Verify Error: Instruction with no computable target " + var13 + "/" + var15.new AssertionException();
               }
            ...
            case 8:
               if (var7.empty()) {
                  throw "Stack Verify Error: jsr return  with no target " + var13 + "/" + var15.new AssertionException();
               }
   ...
   public static int getMaxStack(ConstantPool var0, MutableCodeSegment var1) {
      ...
      for(var12 = 0; var12 < var5.size(); ++var12) {
         ...
         if (var16 == 1 || var16 == 2 || var16 == 3 || var16 == 7) {
            ...
            if (var17 == null) {
               throw "Stack Verify Error: Instruction with no computable target " + var13.new AssertionException();
            }
