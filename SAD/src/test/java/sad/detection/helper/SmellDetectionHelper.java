...
public final class SmellDetectionHelper {
	public static final String[] SMELLS = new String[] { "AntiSingleton", "BaseClassKnowsDerivedClass",
			"BaseClassShouldBeAbstract", "Blob", "ClassDataShouldBePrivate", "ComplexClass", "FunctionalDecomposition",
			"LargeClass", "LazyClass", "LongMethod", "LongParameterList", "ManyFieldAttributesButNotComplex",
			"MessageChains", "RefusedParentBequest", "SpaghettiCode", "SpeculativeGenerality", "SwissArmyKnife",
			"TraditionBreaker" };
	...
	public static void main(final String[] args) {
		try {
			final LineNumberReader reader = new LineNumberReader(
					ProxyDisk.getInstance().fileAbsoluteInput("rsc/ArgoUML0198_Test.csv"));
			final List<String> listOfPaths = new ArrayList<String>();
			String line;
			while ((line = reader.readLine()) != null) {
				String className = line.substring(0, line.indexOf(';'));
				className = className.replace('.', '/');
				className = "D:/Software/P-MARt Workspace/ArgoUML v0.19.8/bin/" + className;
				className += ".class";
			...
			SmellDetectionHelper.analyseCodeLevelModelFromJavaClassFiles(somePaths, "ArgoUML",
	...
	public static final void analyseCodeLevelModel(final String[] someSmells, final String aName,
	...
	public static final void analyseCodeLevelModel(final String[] someSmells, final String aName,
		...
		try {
			...
			SmellDetectionHelper.analyseCodeLevelModel(someSmells, aName, idiomLevelModel, anOutputDirectory);
		} catch (final UnsupportedSourceModelException e) {
			e.printStackTrace(ProxyConsole.getInstance().errorOutput());
		}
	}

	public static final void analyseCodeLevelModelFromEclipse(final String anEclipsePath,
		...
		SmellDetectionHelper.analyseCodeLevelModelFromJARs(arrayOfJarFiles, anEclipsePath, anOutputDirectory);
	}

	public static final void analyseCodeLevelModelFromJARs(final String[] someJARFiles, final String aName,
			final String anOutputDirectory) {
		...
		try {
			...
			SmellDetectionHelper.analyseCodeLevelModel(SmellDetectionHelper.SMELLS, aName, codeLevelModel,
					anOutputDirectory);
	...
	public static final void analyseCodeLevelModelFromJavaClassFiles(final String aClassPath, final String aName,
			final String anOutputDirectoryName) {

		SmellDetectionHelper.analyseCodeLevelModelFromJavaClassFiles(SmellDetectionHelper.SMELLS, aClassPath, aName,
				anOutputDirectoryName);
	}

	public static final void analyseCodeLevelModelFromJavaClassFiles(final String[] somePaths, final String aName,
			final String anOutputDirectoryName) {

		SmellDetectionHelper.analyseCodeLevelModelFromJavaClassFiles(SmellDetectionHelper.SMELLS, somePaths, aName,
				anOutputDirectoryName);
	}

	public static final void analyseCodeLevelModelFromJavaClassFiles(final String[] someSmells, final String aClassPath,
		...
		try {
			...
			SmellDetectionHelper.analyseCodeLevelModel(someSmells, aName, annotatedCodeLevelModel2,
	...
	public static final void analyseCodeLevelModelFromJavaClassFiles(final String[] someSmells,
			final String[] somePaths, final String aName, final String anOutputDirectoryName) {
	...
	public static final void analyseCodeLevelModelFromJavaSourceFilesEclipse(final String aSourcePath,
			final String aName, final String anOutputDirectoryName) {

		SmellDetectionHelper.analyseCodeLevelModelFromJavaSourceFilesEclipse(SmellDetectionHelper.SMELLS, aSourcePath,
				aName, anOutputDirectoryName);
	}

	public static final void analyseCodeLevelModelFromJavaSourceFilesEclipse(final String[] someSmells,
		...
		SmellDetectionHelper.analyseCodeLevelModelFromJavaSourceFilesEclipse(SmellDetectionHelper.SMELLS,
				new String[] { aSourcePath }, new String[] { aSourcePath }, aName, anOutputDirectoryName);
	}
